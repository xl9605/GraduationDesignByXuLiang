...
layui.define("layer",
    function(e) {
     ...
     u.prototype.set = function(e) {
      var a = this;
      return i.extend(!0, a.config, e),
          a
     },
         u.prototype.verify = function(e) {
          var a = this;
          return i.extend(!0, a.config.verify, e),
              a
         },
         ...
         u.prototype.render = function(e) {
               ...
               select: function() {
                ...
                n.each(function(n, l) {
                 var s = i(this),
                     ...
                     v = i(['<div class="layui-unselect ' + a + (d ? " layui-select-disabled": "") + '">', '<div class="' + t + '"><input type="text" placeholder="' + (l.options[0].innerHTML ? l.options[0].innerHTML: e) + '" value="' + (f ? y.html() : "") + '" readonly class="layui-input layui-unselect' + (d ? " " + r: "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (s.find("optgroup")[0] ? " layui-select-group": "") + '">' +
                     function(e) {
                      var i = [];
                      return layui.each(e,
                          function(e, a) { (0 !== e || a.value) && ("optgroup" === a.tagName.toLowerCase() ? i.push("<dt>" + a.label + "</dt>") : i.push('<dd lay-value="' + a.value + '" class="' + (f === a.value ? c: "") + (a.disabled ? " " + r: "") + '">' + a.innerHTML + "</dd>"))
                          }),
                          i.join("")
                     } (s.find("*")) + "</dl>", "</div>"].join(""));
                 u[0] && u.remove(),
                         ...
                         function() {
                          ...
                          n[0].disabled || (layui.each(d,
                              function() {
                               ...
                               this.checked = !1,
                                   t.removeClass(e + "ed"),
                                   t.find(".layui-icon").removeClass(c).html(a[1])
          ...
          return e ? n[e] ? n[e]() : t.error("不支持的" + e + "表单渲染") : layui.each(n,
              function(e, i) {
               i()
              }),
              a
     ...
     d.render(),
         ...
         f.on("submit", s, o).on("click", "*[lay-submit]", o),
         e(l,
             function(e) {
              return d.set(e)
             })
